...
read -p "What is the chromosomes? " chr 
read -p "What is the beginning of the region? " start
read -p "What is the end of the region? " end
read -p "What is the pedigree file? " ped
